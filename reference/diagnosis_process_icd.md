...
#> ℹ [16:10:39] diagnosis_process_icd: processing ICD10 [D261] using [2025-01-01] as censored date.
#> ℹ [16:10:39] diagnosis_process_icd: converting date columns to <Date>.
#> ℹ [16:10:39] diagnosis_process_icd: combining death dates.
#> ℹ [16:10:39] diagnosis_process_icd: matching ICD10 pattern [^(D261)].
#> ℹ [16:10:39] diagnosis_process_icd: calculating survival time and status.
#> ✔ [16:10:39] diagnosis_process_icd: created [D261_status], [D261_time] - ALL DONE.
...
#> ℹ [16:10:39] diagnosis_process_icd: processing ICD10 [M10] using [2025-01-01] as censored date.
#> ℹ [16:10:39] diagnosis_process_icd: converting date columns to <Date>.
#> ℹ [16:10:39] diagnosis_process_icd: combining death dates.
#> ℹ [16:10:39] diagnosis_process_icd: matching ICD10 pattern [^(M10)].
#> ℹ [16:10:39] diagnosis_process_icd: calculating survival time and status.
#> ✔ [16:10:39] diagnosis_process_icd: created [M10_status], [M10_time] - ALL DONE.
...
#> ℹ [16:10:39] diagnosis_process_icd: processing ICD10 [E113] using [2025-01-01] as censored date.
#> ℹ [16:10:39] diagnosis_process_icd: converting date columns to <Date>.
#> ℹ [16:10:39] diagnosis_process_icd: combining death dates.
#> ℹ [16:10:39] diagnosis_process_icd: matching ICD10 pattern [^(E113)].
#> ℹ [16:10:39] diagnosis_process_icd: calculating survival time and status.
#> ✔ [16:10:39] diagnosis_process_icd: created [E113_status], [E113_time] - ALL DONE.
...
#> ℹ [16:10:39] diagnosis_process_icd: processing ICD10 [M10 and E113] using [2025-01-01] as censored date.
#> ℹ [16:10:39] diagnosis_process_icd: converting date columns to <Date>.
#> ℹ [16:10:39] diagnosis_process_icd: combining death dates.
#> ℹ [16:10:39] diagnosis_process_icd: matching ICD10 pattern [^(M10|E113)].
#> ℹ [16:10:39] diagnosis_process_icd: calculating survival time and status.
#> ✔ [16:10:39] diagnosis_process_icd: created [M10_E113_status], [M10_E113_time] - ALL DONE.
