...
#> ℹ [16:10:43] Performing logistic regression with settings:
#> y = outcome (0=control, 1=case)
#> x = PRS
#> cov = (none)
#> ✔ [16:10:43] Completed. Processed 1 exposure(s). N range: 300–300.
head(res1)
#> # A tibble: 1 × 17
...
#> x = group
#> cov = age
#> ! [16:10:43] Exposure 'group' is categorical; please ensure factor() with first level as reference. Levels: A, B, C (ref = A).
#> ℹ [16:10:43] For categorical exposure 'group', interpretation is vs reference 'A'.
#> ✔ [16:10:43] Completed. Processed 1 exposure(s). N range: 400–400.
res2
#> # A tibble: 3 × 17
#>   x_name x_type x_level ref_level y_name     n r2_mcfadden    beta     se      z
#>   <chr>  <chr>  <chr>   <chr>     <chr>  <int>       <dbl>   <dbl>  <dbl>  <dbl>
